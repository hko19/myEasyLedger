...
import { ACCOUNT_TYPE_OPTIONS, API_BASE_URL, CATEGORY_ACCOUNT_TYPES } from '../../utils/constants';
...
function CategoriesPage(props) {
    ...
    */
    ...
    const accountTypeOptions = ACCOUNT_TYPE_OPTIONS(appContext.locale).filter(accountTypeOption => CATEGORY_ACCOUNT_TYPES.includes(accountTypeOption.value))
    ...
    const fetchData = () => {
        axios.get(`${API_BASE_URL}/accountType`).then(response => {
            ...
            let assetsAndLiabilitiesAccountTypes = response.data.filter(accountType => incomeAndExpensesAccountTypeIds.includes(accountType.id));
                            ...
                            : <div className="d-flex w-100 justify-content-between align-items-center">
                                ...
                                <div className="d-lg-none w-50">
                                    <StyledSelect
                                        ...
                                        onChange={selectedOption => history.push(`/categories/${selectedOption.value}`)}
                                    />
                                </div>
                                <div id="create-an-account-button">
                                    ...
                                    >
                                        {chartOfAccountsText[appContext.locale]["Create a category"]}
                                    </button>
                                </div>
                            </div>
                        }
                                                                    ...
                                                                    {appContext.currentPermissionTypeId >= 2
                                                                        ...
                                                                        >
                                                                            <div className="pseudo-td ">
                                                                                <i className="ion ion-md-add fa-fw fa-lg"></i> {chartOfAccountsText[appContext.locale]["Add a new child category..."]}
                                                                            </div>
